...
header('location:login.php');
  ...
  $liberian_login=$_SESSION['liberian_login'];
 $result= mysqli_query($conn,"SELECT * FROM `libraian` WHERE `email`='$liberian_login'");
 $librarian_info=mysqli_fetch_assoc($result);
...
<head>
    ...
    <link rel="icon" type="../assect/image/png" sizes="192x192" href="favicon/android-icon-192x192.png">
    <link rel="icon" type="../assect/image/png" sizes="32x32" href="favicon/favicon-32x32.png">
    <link rel="icon" type="../assect/image/png" sizes="16x16" href="favicon/favicon-16x16.png">
    <!--load progress bar-->
    ...
    <link rel="stylesheet" href="../assect/vendor/data-table/extensions/Responsive/css/responsive.bootstrap.min.css">
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?=ucwords($librarian_info['fname'].' '.$librarian_info['lname'])?></span>
                    ...
                    <div class="nano-content">
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?= $page=='addBook.php'?'open-item':''?><?= $page=='manageBook.php'?'open-item':''?> has-child-item close-item">
