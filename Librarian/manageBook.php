   ...
   ?>
				...
				<div class="col-sm-12">
                                ...
                                <table id="basic-table" class="data-table table table-striped nowrap table-hover table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                      ...
                                      <td><img style="width:50px" src="../images/books/<?=$row['book_image']?> "alt=""></td>
                                        ...
                                        <td><?=date('d-M_Y',strtotime($row['book_purchase_date']))?></td>
                                        <td><?=$row['book_price']?></td>
										 <td><?=$row['book_qty']?></td>
                                        <td><?=$row['available_qti']?></td>
										 <td>
										 <a href="javascript:avoid(0)" class="btn btn-info" data-toggle="modal" data-target="#book-<?=$row['id']?>"><i class="fa fa-eye"></i>View</a>
										 <a href="" class="btn btn-warning" data-toggle="modal" data-target="#update_book-<?=$row['id']?>"><i class="fa fa-pencil"></i>Edit</a>
										  <a href="delete.php?book_delete_id=<?=$row['id']?>?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete ?')"><i class="fa fa-trash-o"></i>Delete</a>
				    ...
				    <!-- update Modal -->
                            ...
                            <div class="modal fade" id="update_book-<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="modal-primary-label">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header state modal-primary">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="modal-primary-label"><i class="fa fa-book"></i>Update Book info</h4>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="form-group">
                                            <label for="available_qty">Available Quentity</label>
                                            <input type="number" class="form-control" name="available_qty" value="<?=$book_info_row['available_qti'];?>">
                                        </div>
   ...
   //update code
	  ...
	  if(isset($_POST['update-book'])){
		 ...
		 $result= mysqli_query($conn,"UPDATE `books` SET `book_name`='$bookName',`book_author_name`='$book_author_name',
		   `book_purchase_date`='$book_purchase_date',`book_price`='$book_price',`book_qty`='$book_qty',`available_qti`='$available_qty' WHERE `id`='$id'");
